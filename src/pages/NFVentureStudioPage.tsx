    ...
    >
      ...
      <div className="fixed bottom-3 right-3 sm:bottom-6 sm:right-6 z-30 flex flex-col items-end gap-2 sm:gap-3 no-print">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5">
          <a
            href="tel:8379879846"
            className="px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl bg-gradient-to-r from-[#fbbf24] via-[#f59e0b] to-[#d97706] text-[#081c3b] font-black text-[11px] sm:text-xs shadow-xl hover:shadow-amber-500/40 transition-all flex items-center gap-1.5 sm:gap-2 hover:scale-105 border border-amber-300 btn-neon-amber"
          ...
          <button
            ...
            className="px-3.5 py-2 sm:px-5 sm:py-2.5 rounded-xl bg-gradient-to-r from-[#0284c7] via-[#0369a1] to-[#081c3b] text-white font-black text-[11px] sm:text-xs uppercase tracking-wider shadow-xl hover:shadow-sky-600/40 transition-all flex items-center gap-1.5 sm:gap-2 border border-sky-400/50 hover:scale-105 cursor-pointer btn-neon-blue animate-shimmer"
          >
