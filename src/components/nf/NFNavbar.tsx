    ...
    >
      ...
      <div className="w-full px-3 sm:px-5 lg:px-6 xl:px-8 2xl:px-10">
        <div className="flex items-center justify-between gap-2 lg:gap-3 xl:gap-4 min-h-14 sm:min-h-16 w-full">
          ...
          <nav className="hidden lg:flex items-center justify-center gap-1 xl:gap-1.5 2xl:gap-2 flex-1 mx-2 xl:mx-4 min-w-0">
            {navButtons.map((item) => {
              ...
              return (
                <button
                  ...
                  title={item.tooltip}
                  className={`h-9 px-2 lg:px-2.5 xl:px-3 2xl:px-3.5 rounded-xl text-[10px] xl:text-xs font-bold uppercase tracking-wide xl:tracking-wider transition-all duration-200 inline-flex items-center gap-1 xl:gap-1.5 shadow-xs border hover:scale-105 active:scale-95 cursor-pointer whitespace-nowrap flex-shrink min-w-0 ${
                    isActive
                      ? isDark
