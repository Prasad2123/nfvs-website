  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Top Tagline Pill Banner with Responsive Text Wrapping */}
        <div className="flex justify-center mb-5 sm:mb-6">
          <div
            className={`inline-flex items-center gap-2 sm:gap-2.5 px-4 sm:px-6 py-1.5 sm:py-2 rounded-full shadow-xl border backdrop-blur-md max-w-full transition-all duration-300 transform hover:scale-[1.01] ${
              isDark
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 sm:space-y-6">
            <div className="space-y-3.5 sm:space-y-4">
              <div
                className={`inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 rounded-lg border text-[10px] sm:text-xs font-mono max-w-full ${
                  isDark
              ...
              >
                ...
                <span
                  className={
                    isDark
                      ? 'text-transparent bg-clip-text bg-gradient-to-r from-[#38bdf8] via-[#60a5fa] to-[#fbbf24]'
                      : 'text-transparent bg-clip-text bg-gradient-to-r from-[#0284c7] via-[#0369a1] to-[#d97706]'
                  }
                >
                  From Lab to Market.
                </span>
              ...
              {/* PDF Exact Strapline inside High-Tech Capsule */}
              <div
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 pt-1">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-4 sm:px-5 py-3 sm:py-3.5 rounded-xl font-bold text-xs sm:text-sm text-[#081c3b] bg-gradient-to-r from-[#fbbf24] via-[#f59e0b] to-[#d97706] hover:brightness-110 shadow-lg border border-amber-300 transition-all text-center cursor-pointer"
              >
              ...
              <a
                href="#tracks"
                className={`inline-flex items-center justify-center gap-1.5 px-3 sm:px-4 py-2 sm:py-3.5 rounded-xl font-mono text-[11px] sm:text-xs font-bold uppercase tracking-wider transition-colors text-center ${
            ...
            {/* Three Engines Strip from PDF Brochure Page 1 */}
            <div className="pt-2">
              <div
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
                <div
                  className={`p-3 rounded-xl glass-card border transition-all ${
                    isDark
                      ? 'border-sky-500/25 hover:border-sky-400/60'
                      : 'border-slate-200 bg-white hover:border-sky-400 shadow-xs'
                  }`}
                >
                  <div className="flex items-center gap-1.5 text-xs font-mono font-black text-sky-500 uppercase">
                    <Rocket className="w-3.5 h-3.5 text-sky-500 flex-shrink-0" />
                    <span>INCUBATE</span>
                  </div>
                  <div className={`text-[10px] font-bold mt-1 ${isDark ? 'text-amber-300' : 'text-amber-700'}`}>
                    Pre-incubation · Prototypes · Seed
                  </div>
                  <p className={`text-[10px] mt-0.5 leading-snug ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
                    3–6 month cohorts, hackathons, PoC micro-grants
                  </p>
                </div>

                <div
                  className={`p-3 rounded-xl glass-card-gold border transition-all ${
                    isDark
                      ? 'border-amber-500/30 hover:border-amber-400/60'
                      : 'border-amber-200 bg-amber-50/40 hover:border-amber-400 shadow-xs'
                  }`}
                >
                  <div className="flex items-center gap-1.5 text-xs font-mono font-black text-amber-500 uppercase">
                    <Zap className="w-3.5 h-3.5 text-amber-500 flex-shrink-0" />
                    <span>BUILD</span>
                  </div>
                  <div className={`text-[10px] font-bold mt-1 ${isDark ? 'text-amber-300' : 'text-amber-800'}`}>
                    MVP · Tech-for-Equity · GTM
                  </div>
                  <p className={`text-[10px] mt-0.5 leading-snug ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
                    Venture build & scale-up with investor-ready traction
                  </p>
                </div>
                ...
                <div
                  className={`p-3 rounded-xl glass-card border transition-all ${
                    isDark
                      ...
                      : 'border-emerald-200 bg-emerald-50/40 hover:border-emerald-400 shadow-xs'
                  }`}
                >
                  <div className="flex items-center gap-1.5 text-xs font-mono font-black text-emerald-500 uppercase">
                    <BarChart3 className="w-3.5 h-3.5 text-emerald-500 flex-shrink-0" />
                    <span>EMBED</span>
                  </div>
                  <div className={`text-[10px] font-bold mt-1 ${isDark ? 'text-emerald-300' : 'text-emerald-800'}`}>
                    Incubator-in-a-Box
                  </div>
                  <p className={`text-[10px] mt-0.5 leading-snug ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
                    Turnkey campus setup, NIRF/IIC alignment, full handover
                  </p>
                </div>
              </div>
            </div>

            {/* Bottom Status Bar from PDF: "One hub. Three engines. Endless pipeline." */}
            <div
              className={`flex flex-wrap items-center justify-between gap-2 p-2.5 rounded-xl border text-[11px] font-mono transition-colors ${
                isDark
            ...
            >
              ...
              <div className={`flex items-center gap-3 ${isDark ? 'text-sky-400' : 'text-[#0284c7]'}`}>
                <a href="https://www.ncfvs.in" target="_blank" rel="noreferrer" className="hover:underline">
                  www.ncfvs.in
                </a>
                <span>·</span>
                <a
                  href="tel:8379879846"
                  className={`hover:underline font-bold ${isDark ? 'text-amber-400' : 'text-amber-700'}`}
                >
                  +91 83798 79846
                </a>
              </div>
          ...
          <div className="lg:col-span-5 flex justify-center w-full">
            <div
              className={`relative w-full max-w-sm sm:max-w-md rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-7 glass-card border-2 shadow-2xl overflow-hidden group transition-colors ${
            ...
            >
              ...
              <div className="space-y-4 sm:space-y-5 relative z-10">
                ...
                <div className="relative py-2 sm:py-3 flex flex-col items-center justify-center">
                  ...
                  {/* 3 Tech Milestones */}
                  <div className="w-full grid grid-cols-3 gap-1.5 sm:gap-2.5 text-center pt-1">
                    <div
                      className={`p-2 sm:p-2.5 rounded-xl border shadow-xs ${
                        isDark ? 'bg-[#0b1c38] border-sky-500/30' : 'bg-sky-50/70 border-sky-200'
                      }`}
                    >
                      <div className={`text-[9px] sm:text-[10px] font-mono font-bold uppercase truncate ${isDark ? 'text-sky-400' : 'text-[#0284c7]'}`}>
                        01. Ideate
                      </div>
                    ...
                    <div
                      className={`p-2 sm:p-2.5 rounded-xl border shadow-xs ${
                        isDark ? 'bg-[#0b1c38] border-amber-500/30' : 'bg-amber-50/70 border-amber-200'
                      }`}
                    >
                      <div className={`text-[9px] sm:text-[10px] font-mono font-bold uppercase truncate ${isDark ? 'text-amber-400' : 'text-amber-700'}`}>
                        02. Incubate
                      </div>
                      <div className={`text-[8px] sm:text-[9px] mt-0.5 truncate ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
                        Labs & Mentors
                    ...
                    <div
                      className={`p-2 sm:p-2.5 rounded-xl border shadow-xs ${
                        isDark ? 'bg-[#0b1c38] border-emerald-500/30' : 'bg-emerald-50/70 border-emerald-200'
                      }`}
                    >
                      <div className={`text-[9px] sm:text-[10px] font-mono font-bold uppercase truncate ${isDark ? 'text-emerald-400' : 'text-emerald-700'}`}>
                        03. Scale
                      </div>
                      <div className={`text-[8px] sm:text-[9px] mt-0.5 truncate ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
                        Venture Funds
                ...
                >
                  ...
                  <div className={`flex items-center gap-2 font-bold ${isDark ? 'text-amber-400' : 'text-amber-700'}`}>
                    <a href="tel:8379879846" className="hover:underline">
                      8379879846
                    </a>
                    <span>|</span>
                    <a href="tel:9209112577" className="hover:underline">
                      9209112577
                    </a>
                  </div>
                </div>
